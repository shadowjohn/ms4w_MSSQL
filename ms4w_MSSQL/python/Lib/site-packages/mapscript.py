...
class CompositingFilter(_object):
    """Proxy of C _CompositingFilter struct."""
...
class LayerCompositer(_object):
    """Proxy of C _LayerCompositer struct."""
...
class styleObj(_object):
    ...
    if _newclass:
        sizeunits = _swig_property(_mapscript.styleObj_sizeunits_get, _mapscript.styleObj_sizeunits_set)
...
class labelObj(_object):
    ...
    if _newclass:
        sizeunits = _swig_property(_mapscript.labelObj_sizeunits_get, _mapscript.labelObj_sizeunits_set)
...
class classObj(_object):
    ...
    if _newclass:
        sizeunits = _swig_property(_mapscript.classObj_sizeunits_get, _mapscript.classObj_sizeunits_set)
...
def msSaveImage(map, img, filename):
    """msSaveImage(mapObj map, imageObj img, char const * filename) -> int"""
